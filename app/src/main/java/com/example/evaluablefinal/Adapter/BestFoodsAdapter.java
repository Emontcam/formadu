package com.example.evaluablefinal.Adapter;
...
import com.example.evaluablefinal.Activity.DetailActivity;
import com.example.evaluablefinal.Domain.Foods;
...
public class BestFoodsAdapter extends RecyclerView.Adapter<BestFoodsAdapter.viewholder> {
    ...
    public void onBindViewHolder(@NonNull BestFoodsAdapter.viewholder holder, int position) {
        ...
        /// OJO EL CHARSEQUENCE PUEDE ESTAR MAL EN ESTA Y TODOS LOS ADAPTER
